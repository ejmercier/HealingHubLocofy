        ...
        <View style={styles.antPickerBody}>
          <View style={[styles.antPickerContent, styles.trFlexBox]}>
            ...
            <View style={[styles.tr1, styles.trFlexBox]}>
              ...
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>1</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
            ...
            <View style={[styles.tr1, styles.trFlexBox]}>
              ...
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>5</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>6</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>7</Text>
              </View>
              <View style={[styles.pickerCellmonth11, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>8</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
            ...
            <View style={[styles.tr1, styles.trFlexBox]}>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>11</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>12</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>13</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>14</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Pressable
                  style={styles.valuePosition}
                  onPress={() => navigation.navigate("SelectTime")}
                >
                  <Text style={styles.text8Typo}>15</Text>
                </Pressable>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>16</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>17</Text>
              </View>
            </View>
            <View style={[styles.tr1, styles.trFlexBox]}>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
              ...
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>19</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>20</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>21</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>1</Text>
              </View>
              ...
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>24</Text>
              </View>
            </View>
            <View style={[styles.tr1, styles.trFlexBox]}>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
              ...
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>26</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value, styles.valuePosition]}>27</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>28</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value, styles.valuePosition]}>29</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>30</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>31</Text>
              </View>
            </View>
            <View style={[styles.tr1, styles.trFlexBox]}>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
              ...
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>3</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>4</Text>
              </View>
              <View style={[styles.pickerCellmonth, styles.pickerLayout]}>
                <Text style={[styles.value2, styles.text8Typo]}>5</Text>
              </View>
